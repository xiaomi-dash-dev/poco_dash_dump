...
function enable_main_mic
{
    ...
    tinymix 'BOT_DMIC_POWER' 1
    tinymix 'TOP_DMIC_POWER' 1

    tinymix 'ADDA_UL_Mux' 'AP_DMIC'
    tinymix 'ADDA_CH34_UL_Mux' 'AP_DMIC'
    tinymix 'ADDA_CH56_UL_Mux' 'AP_DMIC'

    tinymix 'UL_CM1_CH1 ADDA_UL_CH3' 1
    tinymix 'UL_CM1_CH2 ADDA_UL_CH3' 1

    tinymix 'MTKAIF_DMIC' 'Off'
}

function disable_main_mic
{
    echo "disabling main mic"
    tinymix 'UL_CM1_CH1 ADDA_UL_CH3' 0
    tinymix 'UL_CM1_CH2 ADDA_UL_CH3' 0

    tinymix 'BOT_DMIC_POWER' 0
    tinymix 'TOP_DMIC_POWER' 0
}
...
function enable_top_mic
{
    ...
    tinymix 'UL_CM1_CH2 ADDA_UL_CH1' 1
...
function disable_top_mic
{
    ...
    tinymix 'UL_CM1_CH2 ADDA_UL_CH1' 0
